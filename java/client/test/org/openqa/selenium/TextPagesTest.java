...
public class TextPagesTest extends JUnit4TestBase {
  ...
  @Ignore(value = {IE, FIREFOX, CHROME, IPHONE, OPERA, ANDROID, SAFARI, OPERA_MOBILE, PHANTOMJS, MARIONETTE, QTWEBKIT},
  ...
  @Ignore(value = {CHROME, IE, IPHONE, OPERA, ANDROID, SAFARI, OPERA_MOBILE, PHANTOMJS, QTWEBKIT}, reason =
