...
public class TouchScrollTest extends TouchTestBase {
  ...
  public void testCanScrollHorizontally() {
    ...
    @NeedsFreshDriver
    @Test
    public void testCanScrollVerticallyFromWebElementQt() {
        driver.get(pages.longContentPage);
    ...
    @NeedsFreshDriver
    @Test
    public void testCanScrollHorizontallyFromWebElementQt() {
        driver.get(pages.longContentPage);
    ...
    @NeedsFreshDriver
    @Test
    public void testCanScrollVerticallyQt() {
        driver.get(pages.longContentPage);
    ...
    @NeedsFreshDriver
    @Test
    public void testCanScrollHorizontallyQt() {
        driver.get(pages.longContentPage);
